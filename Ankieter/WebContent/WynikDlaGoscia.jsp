			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
					<div class="well bs-component">
						...
						<div class="row form-group">
							<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12" style="padding-bottom: 5px;">
								<a href="Zalogowano.jsp" class="btn btn-primary btn-md" style="width: 100%;">Powrót</a>
							</div>
						</div>
					</div>
				</div>
...
<%
String komunikat = (String) session.getAttribute("komunikatDlaWynikDlaGoscia");	
if(komunikat!=null){
%>
		<script type="text/javascript">
			alert('<%=komunikat%>');
...
session.setAttribute("komunikatDlaWynikDlaGoscia", null);
} else {
